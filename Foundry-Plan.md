...
| **Document ingestion** | `DocumentLoader.cs` + in-memory store | **Import Data wizard** (chunking, embedding, indexing) + optional Logic App for URL ingestion |
...
|---|---|---|
| **None** | Import Data wizard handles chunking/embedding/indexing; manual Blob upload for documents | All portal-driven |
